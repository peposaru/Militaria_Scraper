# Scraping Ruptured Duck Militaria products
...
class rupturedDuckProductsScraper:
    ...
    def scrapePage(self,product):
        ...
        productUrl  = 'https://www.therupturedduck.com'+productSuffix
    ...
    def scrapeData(self,productSoup):
        ...
        # scrapeTitle
            try:
                titleElement   = productSoup.find('h1', class_='product-single__title')
        ...
        # scrapeDesc
            try:
                descElement = productSoup.find('div',class_='rte product-single__description')
        ...
        # scrapePrice
            ...
            try:
                c = CurrencyConverter()
                priceElement   = productSoup.find('span', class_='product-single__price')
...
def main():
    ...
    webScrapeManager = rupturedDuckProductsScraper(dataManager)


    page = 1
    urlCount = 0
    while True:
        url = f'https://www.therupturedduck.com/collections/recently-added-items?page={page}'
        page += 1
        print(f'URL : {url}')
